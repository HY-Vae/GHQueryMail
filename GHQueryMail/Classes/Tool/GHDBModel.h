...
#define SQLREAL     @"REAL"
#define SQLBLOB     @"BLOB"//对象只能是二进制
#define SQLNULL     @"NULL"
#define SQLDATA     @"DATA"//JSON格式的实体对象 （NSArry NSMuatableArry NSDictionary NSMuatableDictionary JZGBaseDataModel）
#define SQLBOOL     @"BOOL"//BOOL类型
#define PrimaryKey  @"primary key"

@interface GHDBModel : NSObject
...
/**
 ...
 @param sqlString SELECT COUNT(*) FROM myTable
 @return 个数
 */
