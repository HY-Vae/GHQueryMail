...
@interface GHCameraModule()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureMetadataOutputObjectsDelegate,AVCaptureMetadataOutputObjectsDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,AVCaptureVideoDataOutputSampleBufferDelegate>
/** 硬件设备 */
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    ...
    if (metadataObjects.count > 0) {
        ...
        if (string.length) {
            ...
            if (self.delegate && [self.delegate respondsToSelector:@selector(cameraModule:resultString:)]) {
                [self.delegate cameraModule:self resultString:resultString];
            }
        }
    }
}
